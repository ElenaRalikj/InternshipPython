...
def button_click(number):
   #we shouldnt delete what s already in there e.delete(0,END)#deleting what s already in the box
    current=e.get()
    e.delete(0,END)
    e.insert(0,str(current)+str(number)) #inserting whatever that number was
